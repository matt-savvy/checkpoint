...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkpoint.address_line_1'
        db.add_column(u'checkpoints_checkpoint', 'address_line_1',
                      self.gf('django.db.models.fields.CharField')(max_length=144, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Checkpoint.address_line_2'
        db.add_column(u'checkpoints_checkpoint', 'address_line_2',
                      self.gf('django.db.models.fields.CharField')(max_length=144, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkpoint.address_line_1'
        db.delete_column(u'checkpoints_checkpoint', 'address_line_1')

        # Deleting field 'Checkpoint.address_line_2'
        db.delete_column(u'checkpoints_checkpoint', 'address_line_2')
