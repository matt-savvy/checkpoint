...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RaceLog'
        db.create_table(u'racelogs_racelog', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nacccusers.NACCCUser'], null=True, blank=True)),
            ('log', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('current_grand_total', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2)),
            ('current_number_of_runs', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'racelogs', ['RaceLog'])


    def backwards(self, orm):
        # Deleting model 'RaceLog'
        db.delete_table(u'racelogs_racelog')
