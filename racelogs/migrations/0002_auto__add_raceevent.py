...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'racelogs_raceevent', (
        ...
        db.send_create_signal(u'racelogs', ['RaceEvent'])


    def backwards(self, orm):
        # Deleting model 'RaceEvent'
        db.delete_table(u'racelogs_raceevent')
    ...
    models = {
        ...
        u'racelogs.racelog': {
            'Meta': {'object_name': 'RaceLog'},
            'current_grand_total': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '8', 'decimal_places': '2'}),
            'current_number_of_runs': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'racer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['racers.Racer']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nacccusers.NACCCUser']", 'null': 'True', 'blank': 'True'})
        },
        u'racers.racer': {
