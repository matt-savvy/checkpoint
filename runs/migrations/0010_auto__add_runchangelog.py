...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RunChangeLog'
        db.create_table(u'runs_runchangelog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company_pk', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('run_pk', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'runs', ['RunChangeLog'])


    def backwards(self, orm):
        # Deleting model 'RunChangeLog'
        db.delete_table(u'runs_runchangelog')
    ...
    models = {
        ...
        u'runs.runchangelog': {
            'Meta': {'object_name': 'RunChangeLog'},
            'company_pk': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'run_pk': ('django.db.models.fields.IntegerField', [], {})
        }
    }
