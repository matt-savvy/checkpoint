...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Run.racer'
        db.delete_column(u'runs_run', 'racer_id')

        # Adding field 'Run.race_entry'
        db.add_column(u'runs_run', 'race_entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['raceentries.RaceEntry']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Run.racer'
        db.add_column(u'runs_run', 'racer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['racers.Racer']),
                      keep_default=False)

        # Deleting field 'Run.race_entry'
        db.delete_column(u'runs_run', 'race_entry_id')
