...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'RunChangeLog', fields ['company_pk']
        db.delete_index(u'runs_runchangelog', ['company_pk'])


    def backwards(self, orm):
        # Adding index on 'RunChangeLog', fields ['company_pk']
        db.create_index(u'runs_runchangelog', ['company_pk'])
    ...
    models = {
        ...
        u'runs.runchangelog': {
            ...
            'company_pk': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
