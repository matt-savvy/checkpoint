...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Run.utc_time_assigned'
        db.add_column(u'runs_run', 'utc_time_assigned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Run.utc_time_assigned'
        db.delete_column(u'runs_run', 'utc_time_assigned')
