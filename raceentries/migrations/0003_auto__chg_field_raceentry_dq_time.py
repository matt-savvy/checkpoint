...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RaceEntry.dq_time'
        db.alter_column(u'raceentries_raceentry', 'dq_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'RaceEntry.dq_time'
        db.alter_column(u'raceentries_raceentry', 'dq_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 12, 0, 0)))
