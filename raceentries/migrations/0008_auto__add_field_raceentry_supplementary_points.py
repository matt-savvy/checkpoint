...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RaceEntry.supplementary_points'
        db.add_column(u'raceentries_raceentry', 'supplementary_points',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RaceEntry.supplementary_points'
        db.delete_column(u'raceentries_raceentry', 'supplementary_points')
