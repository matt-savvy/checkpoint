...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RaceEntry.number_of_runs_completed'
        db.add_column(u'raceentries_raceentry', 'number_of_runs_completed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RaceEntry.number_of_runs_completed'
        db.delete_column(u'raceentries_raceentry', 'number_of_runs_completed')
