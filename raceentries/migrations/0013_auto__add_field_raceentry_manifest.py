...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RaceEntry.manifest'
        db.add_column(u'raceentries_raceentry', 'manifest',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['races.Manifest'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RaceEntry.manifest'
        db.delete_column(u'raceentries_raceentry', 'manifest_id')
