...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.confirmed'
        db.delete_column(u'dispatch_message', 'confirmed')

        # Adding field 'Message.status'
        db.add_column(u'dispatch_message', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.confirmed'
        db.add_column(u'dispatch_message', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Message.status'
        db.delete_column(u'dispatch_message', 'status')
