...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Racer.track'
        db.add_column(u'racers_racer', 'track',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Racer.cargo'
        db.add_column(u'racers_racer', 'cargo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Racer.track'
        db.delete_column(u'racers_racer', 'track')

        # Deleting field 'Racer.cargo'
        db.delete_column(u'racers_racer', 'cargo')
