...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Volunteer.packet_picked_up'
        db.add_column(u'racers_volunteer', 'packet_picked_up',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Volunteer.packet_picked_up'
        db.delete_column(u'racers_volunteer', 'packet_picked_up')
