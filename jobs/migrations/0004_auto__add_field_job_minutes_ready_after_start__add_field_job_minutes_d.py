...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.minutes_ready_after_start'
        db.add_column(u'jobs_job', 'minutes_ready_after_start',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Job.minutes_due_after_start'
        db.add_column(u'jobs_job', 'minutes_due_after_start',
                      self.gf('django.db.models.fields.IntegerField')(default=9999),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.minutes_ready_after_start'
        db.delete_column(u'jobs_job', 'minutes_ready_after_start')

        # Deleting field 'Job.minutes_due_after_start'
        db.delete_column(u'jobs_job', 'minutes_due_after_start')
