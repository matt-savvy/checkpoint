...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manifest.manifest_type'
        db.add_column(u'races_manifest', 'manifest_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manifest.manifest_type'
        db.delete_column(u'races_manifest', 'manifest_type')
